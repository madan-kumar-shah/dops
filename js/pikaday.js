...
}(this, function (moment)
{
    ...
    //     return new Date(new Date().setDate((new Date()).getDate()-new Date(year, month,0).getDate()));
    //    };  
    ...
    defaults = {
        ...
        //minDate:getDaysofMonth(new Date().getFullYear(),new Date().getMonth()-3,new Date().getDate()),
